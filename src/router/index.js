...
export function createRouter () {
  return new Router({
    ...
    routes: [
      ...
      { path: '/customers/', name: 'customers', component: () => import('@/pages/companies/index'), props: (route) => ({ type: 0 }) },
      { path: '/operators/', name: 'operators', component: () => import('@/pages/companies/index'), props: (route) => ({ type: 1 }) },
      { path: '/integrators/', name: 'integrators', component: () => import('@/pages/companies/index'), props: (route) => ({ type: 2 }) },
      { path: '/vendors/', name: 'vendors', component: () => import('@/pages/companies/index'), props: (route) => ({ type: 3 }) },
      { path: '/suppliers/', name: 'suppliers', component: () => import('@/pages/companies/index'), props: (route) => ({ type: 4 }) },
      { path: '/agents/', name: 'agents', component: () => import('@/pages/companies/index'), props: (route) => ({ type: 5 }) },
