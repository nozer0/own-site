<template>
  <Form ref="form" :model="currentData" :rules="rules" :label-width="60">
        ...
        <div slot="content">
         ...
         <!--  <Row>
          ...
          <FormItem label="备注" :label-width="48">
            <Input v-model="currentData.requirement" type="textarea" :autosize="{minRows:2}" size="small" :disabled="freezed"></Input>
          </FormItem>
        </div>
      </Panel>
      <Panel name="progress">
    ...
    <FormItem label="审核意见" :label-width="74">
      <Input v-model="currentData.description" type="textarea" :autosize="{minRows:2}" size="small" :disabled="auditable"></Input>
    </FormItem>
    <Row>
      <Col :xs="24" :sm="12">
